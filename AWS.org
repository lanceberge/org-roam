...
* Fargate
  ...
  - Create a load balancer
    - Create a new security group
      - It should take traffic on port 80
      - Make sure the security group allows inbound traffic on port 80 from all ips
  ...
  - Create a service - runs the task definition in the cluster
    ...
    - Click on the security group of this service and enable it to receive inbound traffic from the LB
      - All TCP -> the security group of the LB


  - Potentially went wrong:
    - Target group
    - subnets in the service
